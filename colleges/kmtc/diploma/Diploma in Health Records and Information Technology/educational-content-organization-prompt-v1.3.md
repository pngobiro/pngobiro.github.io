...
> - Add clinical relevance and practical applications
> - **Use ASCII diagrams** for visual concepts (network topologies, data structures) inside code blocks
> - Include study tips and memory aids where helpful
...
### 11.10 Syntax Highlighting Standards

> **FORMAT CODE BLOCKS CORRECTLY**
> - Use `<pre><code class="language-sql">` for SQL queries
> - Use `<pre><code class="language-python">` for Python code
> - Use `<pre><code class="language-html">` for HTML examples
> - **Rationale**: Ensures technical content is readable and distinct from text.
...
## 13. Content Enhancement Best Practices

### 13.1 Self-Contained Content
- **Goal**: Questions should make sense on their own.
- **Action**: If a question refers to "the table above", repeat the table in the question card or the answer explanation if strictly necessary for context (though avoid excessive duplication if table is massive).

### 13.2 Visual Learning with ASCII
- **Goal**: Visualize concepts without external images.
- **Action**: Use ASCII art for technical concepts.
- **Examples**:
  ...
  **5. Timeline (History/Epidemiology):**
  ```
  1990 -------- 2000 -------- 2010 -------- 2020
  (Event A)     (Event B)     (Event C)
  ```

  **6. Hierarchy/Org Chart (Management):**
  ```
       [CEO]
         |
    +----+----+
...
### 13.3 Step-by-Step Logic
- **Goal**: Clearer explanations for complex problems.
- **Action**: Mandate "Step 1, Step 2, Step 3" format for:
  - Math calculations
  - Logical deductions
