...
Status Update: Folder structure created (HTML Templating in progress).
- Created directory structure: kmtc-his/ with topics/, assets/images/, styles/, js/
- Created index.html with table of contents for 5 units
