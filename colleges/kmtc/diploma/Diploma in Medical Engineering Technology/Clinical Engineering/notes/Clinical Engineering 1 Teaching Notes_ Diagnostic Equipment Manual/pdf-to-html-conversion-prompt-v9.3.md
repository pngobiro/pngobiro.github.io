...
- **Improved List Formatting**: Strategic bold emphasis for pharmacological terms, **v9.2: Enhanced nested list support with automatic numbering styles**
...
6.  **Content Transfer & Semantic Conversion**: Move *corrected* content from MMD to HTML chunks with proper semantic markup. **Convert identified list-like patterns into proper HTML `<ul>` or `<ol>` elements, preserving the exact text content of each item.** **v9.2 NEW: Identify and properly structure nested lists using the hierarchical patterns defined in the Nested List Handling section - use different numbering styles (numbers → letters → roman numerals) for different nesting levels.** Maintain the **linear flow** provided by the MMD.
...
## Nested List Handling (v9.2 NEW)

### Nested List Structure Guidelines
When converting PDF content that contains nested or hierarchical lists, follow these specific patterns to ensure proper semantic structure and visual differentiation:

#### 1. Identifying Nested Lists in Source Content
- **Primary Lists**: Main numbered or bulleted items at the top level
- **Secondary Lists**: Sub-items indented under primary items (often with different prefixes like letters, roman numerals, or different bullet styles)
- **Tertiary Lists**: Further nested items under secondary lists

#### 2. HTML Structure for Nested Lists
Use proper semantic nesting with different list types:

```html
<!-- Level 1: Main numbered list -->
<ol class="enhanced-list">
    <li class="list-item">
        <span class="list-marker"></span>
        <span class="list-content">
            Primary item text
            <!-- Level 2: Nested ordered list with letters -->
            <ol class="enhanced-list" style="margin-top: 0.5rem;">
                <li class="list-item">
                    <span class="list-marker"></span>
                    <span class="list-content">Secondary item (will show as 'a')</span>
                </li>
                <li class="list-item">
                    <span class="list-marker"></span>
                    <span class="list-content">
                        Another secondary item
                        <!-- Level 3: Nested ordered list with roman numerals -->
                        <ol class="enhanced-list" style="margin-top: 0.5rem;">
                            <li class="list-item">
                                <span class="list-marker"></span>
                                <span class="list-content">Tertiary item (will show as 'i')</span>
                            </li>
                        </ol>
                    </span>
                </li>
...
#### 3. Mixed List Types (Ordered within Unordered)
When the source content shows bulleted sub-items under numbered main items:
...
<ol class="enhanced-list">
    <li class="list-item">
        ...
        <span class="list-content">
            ...
            <ul class="enhanced-list" style="margin-top: 0.5rem;">
                <li class="list-item">
                    <span class="list-marker"></span>
                    <span class="list-content">Bulleted sub-item</span>
                </li>
            </ul>
        </span>
    </li>
...
#### 4. CSS Numbering Behavior (Automatic)
The CSS automatically handles different numbering styles for nested levels:
- **Level 1**: Numbers (1, 2, 3...)
- **Level 2**: Lowercase letters (a, b, c...)
- **Level 3**: Lowercase roman numerals (i, ii, iii...)
- **Nested UL in OL**: Different bullet shapes (square, circle, etc.)

#### 5. Content Preservation in Nested Lists
- **CRITICAL**: All text content within nested lists must be preserved verbatim from the source
- **Structure**: Only the list structure and numbering style changes, never the content
- **Indentation**: Use the CSS margin-top style for proper visual nesting
- **Accessibility**: Maintain proper semantic nesting for screen readers

#### 6. Common Nested List Patterns to Convert
- **Medical/Scientific**: Symptoms → Sub-symptoms → Specific manifestations
- **Procedural**: Steps → Sub-steps → Detailed actions
- **Categorical**: Categories → Subcategories → Specific items
- **Hierarchical**: Main topics → Subtopics → Details

### Implementation Checklist for Nested Lists
1. ✅ Identify hierarchical structure in source PDF
2. ✅ Use appropriate `<ol>` or `<ul>` tags for each level
3. ✅ Apply `enhanced-list` class to all list levels
4. ✅ Use proper `list-item`, `list-marker`, and `list-content` structure
5. ✅ Add `margin-top: 0.5rem` style for visual nesting
6. ✅ Preserve all original text content verbatim
7. ✅ Test that CSS automatically applies correct numbering styles
...
**CRITICAL:** Every topic file MUST include the lightbox modal HTML structure before the closing `</body>` tag and MUST load the `interactions.js` script for proper image lightbox functionality.
                        ...
                        <div class="content-card">
                            ...
                            <ol class="enhanced-list">
                                ...
                                <li class="list-item">
                                    <span class="list-marker"></span>
                                    <span class="list-content">
                                        [Verbatim list item with nested content]
                                        <!-- Nested List Example (v9.2) -->
                                        <ol class="enhanced-list" style="margin-top: 0.5rem;">
                                            <li class="list-item">
                                                <span class="list-marker"></span>
                                                <span class="list-content">[Nested item - will show as 'a']</span>
                                            </li>
                                            <li class="list-item">
                                                <span class="list-marker"></span>
                                                <span class="list-content">[Another nested item - will show as 'b']</span>
                                            </li>
                                        </ol>
                                    </span>
                                </li>
...
hello_world()</code></pre>
    ...
    <!-- Lightbox Modal -->
    <div id="lightbox" class="lightbox-modal" hidden aria-hidden="true" role="dialog" aria-label="Image viewer">
...
/* Nested List Enhancements - Different numbering styles (v9.2 NEW) */
/* Level 1: Numbers (default) */
ol.enhanced-list {
    counter-reset: list-counter;
}

/* Level 2: Lowercase letters */
ol.enhanced-list ol.enhanced-list {
    counter-reset: list-counter-alpha;
}

ol.enhanced-list ol.enhanced-list .list-item {
    counter-increment: list-counter-alpha;
}

ol.enhanced-list ol.enhanced-list .list-marker::before {
    content: counter(list-counter-alpha, lower-alpha);
}

/* Level 3: Lowercase roman numerals */
ol.enhanced-list ol.enhanced-list ol.enhanced-list {
    counter-reset: list-counter-roman;
}

ol.enhanced-list ol.enhanced-list ol.enhanced-list .list-item {
    counter-increment: list-counter-roman;
}

ol.enhanced-list ol.enhanced-list ol.enhanced-list .list-marker::before {
    content: counter(list-counter-roman, lower-roman);
}

/* Unordered lists nested in ordered lists - use different bullet styles */
ol.enhanced-list ul.enhanced-list .list-marker {
    width: 12px;
    height: 12px;
...
ol.enhanced-list ul.enhanced-list .list-marker::before {
    content: '';
}

/* Second level nested ul - circle bullets */
ol.enhanced-list ul.enhanced-list ul.enhanced-list .list-marker {
    background: transparent;
    border: 2px solid var(--color-secondary);
    border-radius: var(--radius-full);
}

/* Third level nested ul - square bullets */
ol.enhanced-list ul.enhanced-list ul.enhanced-list ul.enhanced-list .list-marker {
