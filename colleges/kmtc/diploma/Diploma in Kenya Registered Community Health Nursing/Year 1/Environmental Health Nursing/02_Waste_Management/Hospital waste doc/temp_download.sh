...
# --- Configuration ---
MMD_FILE="An-Orientation-Guide-for-Health-Workers-in-Health-Care-Waste-Management.txt" # Input MMD file name
...
grep -oP 'https://cdn.mathpix.com/cropped/[^)]+' "$MMD_FILE" | sed 's/}$//' | \
