...
# --- Configuration ---
MMD_FILE="behavioral-science-sociology-anthropology/Behavioral_Science_3.mmd" # Input MMD file name
OUTPUT_DIR="behavioral-science-sociology-anthropology/assets/images" # Output directory for images
