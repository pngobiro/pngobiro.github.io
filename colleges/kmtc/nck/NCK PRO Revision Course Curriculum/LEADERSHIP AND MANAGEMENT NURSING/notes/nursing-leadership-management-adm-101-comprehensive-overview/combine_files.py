...
def combine_files(output_file="combined_output.txt"):
    ...
    Files to combine:
    - styles/main.css
    - nursing-leadership-management-adm-101-comprehensive-overview_cleaned.txt
    - exam-template.html
    - index-template-v1.1.html
    - pdf-to-html-conversion-prompt-v9.9.md
    ...
    files_to_combine = [
        ...
        ("nursing-leadership-management-adm-101-comprehensive-overview_cleaned.txt", "nursing-leadership-management-adm-101-comprehensive-overview_cleaned.txt"),
        ...
        ("comprehensive-exam-template.html", "comprehensive-exam-template.html"),
    ]
