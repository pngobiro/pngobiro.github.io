...
def main():
    ...
    parser.add_argument('action', choices=['dashboard', 'scan', 'process', 'list', 'split', 'analyze', 'fix-paths', 'pack', 'download-images', 'index', 'extract', 'init-structure', 'fix-styling', 'set-title'], help='Action to perform')
