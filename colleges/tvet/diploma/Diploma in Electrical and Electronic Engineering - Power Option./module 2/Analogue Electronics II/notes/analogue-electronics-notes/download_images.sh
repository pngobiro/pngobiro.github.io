...
# --- Configuration ---
MMD_FILE="analogue-electronics-notes.txt" # Input MMD file name
OUTPUT_DIR="analogue-electronics/assets/images" # Output directory for images
PROJECT_ROOT="analogue-electronics" # Project root relative to script location (if needed)
